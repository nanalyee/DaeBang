      ...
      <div class="col-lg-12 portfolio-item first">
        <div class="border portfolio-img rounded overflow-hidden">
          <div class="col-lg-12 text-center">
            <h1 class="display-7 my-4 mb-10">삼성화재 유성연수원 ↔ 유성온천역</h1>
          </div>
          <br />
          <div class="row g-5">
            <div class="col-lg-6">
            ...
            <div class="col-lg-5">
              ...
              <p class="mb-4">
                교통 상황 서비스 !<br />
                유성온천역에서 SSAFY 대전캠퍼스까지의 경로에 대한 상세 정보를 제공합니다.
              </p>
    ...
    <b-sidebar id="sidebar-right" title="실시간 한마디" right shadow backdrop backdrop-variant="dark" width="620px">
      ...
      <div id="boardList" class="px-3 py-2 bg-white">
        ...
        >
          ...
          >
            <div class="row my-3" v-if="item.articletype == 1">
...
export default {
  name: "YuseongStationView",
  created() {
    // 유성온천역 위도,경도
    this.setOrigin("127.34161199628288,36.353508984226025");
    // 게시판 테스트용
